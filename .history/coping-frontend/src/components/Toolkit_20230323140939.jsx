    ...
    <div>
      ...
      {userFavorites ? (
        userFavorites.map((favorite) => {
          ...
          return (
            <div key={favorite.resource_id}>
              <h2> {favorite.resource_id.title} </h2>
              <p> {favorite.resource_id.preview_text} </p>
              <p> Time Requirement: {favorite.resource_id.time_requirement} </p>
            </div>
          );
        })
      ) : (
